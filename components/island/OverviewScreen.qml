                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: miniPrevHover.hovered ? Qt.rgba(Theme.surfaceText.r, Theme.surfaceText.g, Theme.surfaceText.b, 0.15) : Qt.rgba(Theme.surfaceText.r, Theme.surfaceText.g, Theme.surfaceText.b, 0.05)
                                Behavior on color { ColorAnimation { duration: 150 } }
                                
                                Text { anchors.centerIn: parent; text: "\uf048"; font.pixelSize: 12; color: Theme.surfaceText }
                                
                                HoverHandler { id: miniPrevHover }
                            ...
                            Rectangle {
                                ...
                                color: miniPlayHover.hovered ? Theme.secondary : Theme.primary
                                Behavior on color { ColorAnimation { duration: 150 } }
                                
                                Text { anchors.centerIn: parent; text: isPlaying ? "\uf04c" : "\uf04b"; font.pixelSize: 16; color: Theme.primaryText }
                                
                                HoverHandler { id: miniPlayHover }
                            ...
                            Rectangle {
                                width: 36; height: 36; radius: 18; 
                                color: miniNextHover.hovered ? Qt.rgba(Theme.surfaceText.r, Theme.surfaceText.g, Theme.surfaceText.b, 0.15) : Qt.rgba(Theme.surfaceText.r, Theme.surfaceText.g, Theme.surfaceText.b, 0.05)
                                Behavior on color { ColorAnimation { duration: 150 } }
                                
                                Text { anchors.centerIn: parent; text: "\uf051"; font.pixelSize: 12; color: Theme.surfaceText }
                                
                                HoverHandler { id: miniNextHover }
